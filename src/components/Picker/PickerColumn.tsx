...
export const useColumnData = (componentName: string) => {
...
const PickerColumn = ({
  ...
  const updateScrollerWhileMoving = useCallback((aNextScrollerTranslate: number) => {
    let nextScrollerTranslate = aNextScrollerTranslate;
  ...
  const handleTouchMove = useCallback((event: TouchEvent) => {
    ...
    const nextScrollerTranslate = startScrollerTranslate
